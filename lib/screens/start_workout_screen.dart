...
class _StartWorkoutScreenState extends State<StartWorkoutScreen> {
  ...
  List<Widget> _buildTrainingCards() {
    return List.generate(widget.trainings.length, (trainingIndex) {
            ...
            children: [
              ...
              Center(
                child: Checkbox(
                  ...
                  value: _trainingResults[trainingIndex].sets[setIndex].done,
                              ...
                              for (int i = setIndex;
                                  i <
                                      _trainingResults[trainingIndex]
                                          ...
                                          .length;
                                  i++) {
                                _trainingResults[trainingIndex].sets[i].done =
                                    false;
                              }
                            }
                          });
